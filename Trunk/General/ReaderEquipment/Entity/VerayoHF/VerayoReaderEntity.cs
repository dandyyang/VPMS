...
namespace ReaderEquipment.Entity.VerayoHF
{
    ...
    /// Verayo读写器实体
    /// </summary>
    public class VerayoReaderEntity : EventArgs
    {
        public VerayoReaderEntity()
        {

        }

        public VerayoReaderEntity(string cmd)
        {
            ...
            else
            {
                try
                {
                    ...
                    this._ID = cmd.Substring(0, 8);
                    this._MachineID = cmd.Substring(8, 2);
                    this.UploadingMode = cmd.Substring(10, 2);
                    this.WorkingMode = cmd.Substring(12, 2);
                    this._ReadTimeInterval = cmd.Substring(14, 2);
                    this.ReadCardParam = cmd.Substring(16, 4);
                    this._CardType = cmd.Substring(20, 2);
                    this._PeaceLength = cmd.Substring(22, 2);
                    this._RecordSaveFrequency = cmd.Substring(24, 2);
                    this._HornSwitch = cmd.Substring(26, 2);
                    this._HornSoundInterval = cmd.Substring(28, 2);
                    this._HornSountTimes = cmd.Substring(30, 2);
                    this.AlarmMode = cmd.Substring(32, 2);
                    this.M1CardKeyType = cmd.Substring(34, 2);
