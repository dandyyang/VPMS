...
{
    public class YuChuanWriter : AbstractICWriter
    {
        #region 字段、属性
        ...
        public override bool InitConsumptionSectionPwd(string strPwd)
        {
            ...
            try
            {
                res = SetCardPassword(3, strPwd);
                res = SetCardPassword(4, strPwd);
                res = SetCardPassword(5, strPwd);
                res = SetCardPassword(6, strPwd);
                res = SetCardPassword(7, strPwd);
            }
            catch (Exception ex)
            {
                throw ex;
