...
namespace DAL.IDAL.Management.DataRightsManagement
{
    public interface IDataRightsRoleDA : IDataBaseCommandDA<DataRightsRole_drr_Info>, IExtraDA, IMainDA<DataRightsRole_drr_Info>
    {
        /// <summary>
        /// 取得所有角色列表
